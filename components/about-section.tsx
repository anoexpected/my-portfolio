  ...
  return (
    <section id="about" className="py-16 md:py-20 bg-[#FFF8DC]">
      <div ref={aboutInViewRef} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className={`text-center mb-12 md:mb-16 ${aboutInView ? "animate-fade-in-up" : "opacity-0"}`}>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          {/* Professional Photo */}
          <div className={`relative ${aboutInView ? "animate-fade-in-right" : "opacity-0"}`}>
          ...
          {/* Content */}
          <div className={`space-y-6 md:space-y-8 ${aboutInView ? "animate-fade-in-left" : "opacity-0"}`}>
