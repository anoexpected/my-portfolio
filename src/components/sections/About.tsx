      ...
      <div ref={aboutInViewRef} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            >
              I&apos;ve worked on projects ranging from AI-powered applications to scalable web platforms, focusing on creating elegant solutions to complex problems. Final-year student at Jawaharlal Nehru Technological University, Kakinada (JNTUK), graduating June 2026.
            </p>
          </div>
        </div>
      </div>
